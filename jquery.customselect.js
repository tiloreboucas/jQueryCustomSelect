    ...
    $.fn.customselect = function (method) {
        ...
        var methods = {
            ...
            build: function () {
                ...
                if (($($this.attr.target).attr('data-orderbyvalue') != "") && ($($this.attr.target).attr('data-orderbyvalue') != undefined)) $this.attr.orderbyvalue = $($this.attr.target).attr('data-orderbyvalue');
                else $this.attr.orderbyvalue = false;
            ...
            buildListItens: function () {
                ...
                function byValueDesc(a, b) { //return a.text < b.text; 
                    if ((a.value * 1) > (b.value * 1)) return -1;
                    if ((a.value * 1) < (b.value * 1)) return 1;
                    return 0;
                }

                if ($this.attr.ordination != 'manual') {

                    if ($this.attr.ordination == 'desc') {
                        objListItens.sort(($this.attr.orderbyvalue ? byValueDesc : byTextDesc));
                    } else {
                        objListItens.sort(($this.attr.orderbyvalue ? byValueAsc : byTextAsc));
                    }
                }
